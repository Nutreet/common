...
const (
	UserService_Register_FullMethodName             = "/gen.user.UserService/Register"
	UserService_GetAuthenticatedUser_FullMethodName = "/gen.user.UserService/GetAuthenticatedUser"
)
...
func (c *userServiceClient) GetAuthenticatedUser(ctx context.Context, in *GetAuthenticatedUserRequest, opts ...grpc.CallOption) (*GetAuthenticatedUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetAuthenticatedUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gen.user.UserService",
